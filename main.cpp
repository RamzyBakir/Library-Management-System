                ...
                if(cnt==0){
                    ...
                    if (shift_index != -1) {
                        if(customer_Books[actual_customer_index-1].Num_of_Borrowed_Books()>0){
                            cout<<"Cannot delete this customer , because he has borrowed books."<<endl;
                            cout<<"Go return all of the customer books first."<<endl<<endl;
                        } else if(customer_Books[actual_customer_index-1].Num_of_Borrowed_Books()==0){
